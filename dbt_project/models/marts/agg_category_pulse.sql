...
grid as (
    ...
    from weeks w cross join categories c
),
...
from grid g
left join activity a  on g.pulse_week = a.pulse_week  and g.category = a.category
left join events   e  on g.pulse_week = e.pulse_week  and g.category = e.category
left join gaps     gp on g.pulse_week = gp.pulse_week and g.category = gp.category
